          ...
          <table className="pf-table">
            <thead>
              <tr>
                ...
                <th className="num">
                  <Tip def="gap ซ้ายมือในหน่วยราคา: ราคาต้องขยับกี่ % ตลาดถึงจะคาดเท่ากับที่เราคาดพอดี. บรรทัดล่างคือช่วงที่ได้ถ้าเลือกวิธีวัดการเติบโตอีกแบบที่มีเหตุผลพอกัน — ช่วงแคบ = ทุกวิธีเห็นตรงกัน เชื่อเลขข้างบนได้; ช่วงกว้าง = คำตอบขึ้นกับว่าเราเลือก anchor ไหน มากกว่าขึ้นกับตัวธุรกิจ. ตารางนี้ไม่เรียงตามคอลัมน์นี้โดยตั้งใจ — การเรียงตามส่วนลดคือการทำสัญญาณซื้อ">
                  ...
                  <td className="num">
                    {r.fair_discount_pct != null ? (
                      <>
                        ...
                        {/* เลขส่วนลดที่ยืนลำพังจะถูกอ่านเป็นราคาเป้าหมายเสมอ จึงต้องมีอะไรอยู่ติดกัน
                            — Phase 41 เปลี่ยนจาก ±%/pp มาเป็นช่วงนี้ เพราะ ±%/pp เท่ากับ
                            7 × (ราคาที่คุ้มค่า ÷ ราคาตลาด) คือเลขเดิมที่พิมพ์อยู่ข้างบนแล้ว
                            ส่วนช่วงนี้บอกของใหม่จริง: คำตอบขึ้นกับการเลือก anchor แค่ไหน */}
                        {r.fair_spread_pp != null && (
                          /* ช่วงแคบเพราะเพดาน growth ต้องไม่ระบายเขียว — ไม่งั้นคอลัมน์นี้จะยิ่ง
                             ดูมั่นใจตอนที่ยิ่งควรระวัง ซึ่งแย่กว่าไม่มีคอลัมน์เลย */
                          <div className={`muted-sm sc-spread-${r.fair_narrow_by_cap ? "mixed" : r.fair_level}`}>
                            ±{Math.round(r.fair_spread_pp / 2)}pp ตามวิธีวัด
                            {r.fair_narrow_by_cap && " (เพดาน)"}
                          </div>
                        )}
                      </>
                    ) : (
